...
class NeosiakBot(Driver):
    ...
    def open_sidebar(self, go_to):
        """Metode untuk membuka menu dari sidebar."""
        ...
        for element in menu_elements:
            ...
            if get_text:  # Filter opsional jika ada elemen kosong
                ...
                if get_text == go_to:
                    ...
                    self._time.sleep(2)  # Tunggu halaman terbuka

                    # ==========================================
                    # PERBAIKAN: Pisahkan logika khusus KRS
                    # ==========================================
                    if go_to == "Pengisian KRS":
                        info_selector = '#kt_app_content_container > div > div > div:nth-child(2) > h4'

                        # Cek dulu apakah elemen h4 ada agar tidak timeout
                        if self.driver.is_element_present(info_selector):
                            ...
                            if "Ditutup" in get_info:
                                ...
                                """)
                                self._time.sleep(4)
                                return  # Keluar dari fungsi jika KRS ditutup

                    # Keluar dari loop for setelah berhasil klik menu yang dituju
                    break
